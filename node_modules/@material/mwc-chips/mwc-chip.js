...
*/
import { ComponentElement, MDCWebComponentMixin, html } from "../mwc-base/component-element.js";
import { style } from './mwc-chip-css.js';
import { MDCChip } from "../chips/index.js";
...
export class Chip extends ComponentElement {
  ...
  _render({
    ...
    const trailingIconPart = trailingIcon ? html`<i class="material-icons mdc-chip__icon mdc-chip__icon--trailing">${trailingIcon}</i>` : ''; // TODO(sorvell) #css: added display
