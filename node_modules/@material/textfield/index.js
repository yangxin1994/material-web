...
import { MDCRipple, MDCRippleFoundation, RippleCapableSurface } from "../ripple/index.js";
/* eslint-enable no-unused-vars */

import { getMatchesProperty } from "../ripple/util.js";
import { cssClasses, strings } from "./constants.js";
import { MDCTextFieldAdapter, FoundationMapType } from "./adapter.js";
import MDCTextFieldFoundation from "./foundation.js";
/* eslint-disable no-unused-vars */

import { MDCLineRipple, MDCLineRippleFoundation } from "../line-ripple/index.js";
import { MDCTextFieldHelperText, MDCTextFieldHelperTextFoundation } from "./helper-text/index.js";
import { MDCTextFieldIcon, MDCTextFieldIconFoundation } from "./icon/index.js";
import { MDCFloatingLabel, MDCFloatingLabelFoundation } from "../floating-label/index.js";
import { MDCNotchedOutline, MDCNotchedOutlineFoundation } from "../notched-outline/index.js";
/* eslint-enable no-unused-vars */
...
class MDCTextField extends MDCComponent {
  ...
  initialize(rippleFactory = (el, foundation) => new MDCRipple(el, foundation), lineRippleFactory = el => new MDCLineRipple(el), helperTextFactory = el => new MDCTextFieldHelperText(el), iconFactory = el => new MDCTextFieldIcon(el), labelFactory = el => new MDCFloatingLabel(el), outlineFactory = el => new MDCNotchedOutline(el)) {
    ...
    if (this.root_.classList.contains(cssClasses.BOX)) {
      ...
      const adapter = Object.assign(MDCRipple.createAdapter(
