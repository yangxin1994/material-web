...
import MDCChipFoundation from "./foundation.js";
...
class MDCChip extends MDCComponent {
  ...
  initialize() {
    this.leadingIcon_ = this.root_.querySelector(strings.LEADING_ICON_SELECTOR); // Adjust ripple size for chips with animated growing width. This applies when filter chips without
  ...
  getDefaultFoundation() {
    ...
    Object.assign({
      ...
      notifyInteraction: () => this.emit(strings.INTERACTION_EVENT, {
        chip: this
      }, true
      /* shouldBubble */
      ),
      notifyTrailingIconInteraction: () => this.emit(strings.TRAILING_ICON_INTERACTION_EVENT, {
        chip: this
      }, true
      /* shouldBubble */
      ),
      notifyRemoval: () => this.emit(strings.REMOVAL_EVENT, {
        chip: this
      }, true
      /* shouldBubble */
      ),
