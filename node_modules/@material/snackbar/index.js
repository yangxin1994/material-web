 ...
 */
import { MDCComponent } from "../base/index.js";
import MDCSnackbarFoundation from "./foundation.js";
...
export class MDCSnackbar extends MDCComponent {
  ...
  getDefaultFoundation() {
    ...
    return new MDCSnackbarFoundation({
      ...
      registerTransitionEndHandler: handler => this.root_.addEventListener(getCorrectEventName(window, 'transitionend'), handler),
      deregisterTransitionEndHandler: handler => this.root_.removeEventListener(getCorrectEventName(window, 'transitionend'), handler),
