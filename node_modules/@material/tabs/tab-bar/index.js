...
import { MDCTab, MDCTabFoundation } from "../tab/index.js";
...
export class MDCTabBar extends MDCComponent {
  ...
  getDefaultFoundation() {
    return new MDCTabBarFoundation({
      ...
      bindOnMDCTabSelectedEvent: () => this.listen(MDCTabFoundation.strings.SELECTED_EVENT, this.tabSelectedHandler_),
      unbindOnMDCTabSelectedEvent: () => this.unlisten(MDCTabFoundation.strings.SELECTED_EVENT, this.tabSelectedHandler_),
