...
import { getCorrectPropertyName } from "../../animation/index.js";
...
export default class MDCTabBarFoundation extends MDCFoundation {
  ...
  layoutIndicator_() {
    const isIndicatorFirstRender = !this.isIndicatorShown_; // Ensure that indicator appears in the right position immediately for correct first render.
    ...
    requestAnimationFrame(() => {
      ...
      if (shouldNotify) {
        this.adapter_.notifyChange({
          activeTabIndex: this.activeTabIndex_
        });
      }
    });
  }
