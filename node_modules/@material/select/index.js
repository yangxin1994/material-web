...
import { MDCFloatingLabel } from "../floating-label/index.js";
import { MDCLineRipple } from "../line-ripple/index.js";
import { MDCRipple, MDCRippleFoundation } from "../ripple/index.js";
import MDCSelectFoundation from "./foundation.js";
...
export class MDCSelect extends MDCComponent {
  ...
  initialize(labelFactory = el => new MDCFloatingLabel(el), lineRippleFactory = el => new MDCLineRipple(el)) {
