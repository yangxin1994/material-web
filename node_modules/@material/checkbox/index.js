 ...
 */
import { getCorrectEventName } from "../animation/index.js";
import MDCComponent from "../base/component.js";
/* eslint-disable no-unused-vars */

import { MDCSelectionControlState, MDCSelectionControl } from "../selection-control/index.js";
/* eslint-enable no-unused-vars */

import MDCCheckboxFoundation from "./foundation.js";
import { MDCRipple, MDCRippleFoundation } from "../ripple/index.js";
...
class MDCCheckbox extends MDCComponent {
  ...
  getDefaultFoundation() {
    return new MDCCheckboxFoundation({
      ...
      registerAnimationEndHandler: handler => this.root_.addEventListener(getCorrectEventName(window, 'animationend'), handler),
      deregisterAnimationEndHandler: handler => this.root_.removeEventListener(getCorrectEventName(window, 'animationend'), handler),
