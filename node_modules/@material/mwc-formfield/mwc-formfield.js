...
*/
import { ComponentElement, html, MDCWebComponentMixin } from "../mwc-base/component-element.js";
import { callWhenReady, findAssignedNode, afterNextRender } from "../mwc-base/utils.js";
import { classString as c$ } from "../../@polymer/lit-element/lit-element.js";
import { style } from './mwc-formfield-css.js';
import { MDCFormField } from "../form-field/index.js";
...
export class Formfield extends ComponentElement {
  ...
  get _input() {
    return this.__input = this.__input || findAssignedNode(this._root.querySelector('slot'), '*');
  }
