...
import { MDCRipple } from "../ripple/index.js";
import { afterNextRender } from "../mwc-base/utils.js"; // TODO(sorvell): These are MDC utils. Would be nice to use em, but they don't appear to be easily
...
export class MDCWCRippleContainer extends MDCWCRipple {
  createAdapter() {
    ...
    return {
      ...
      deregisterInteractionHandler: (evtType, handler) => container.removeEventListener(evtType, handler, applyPassive()),
