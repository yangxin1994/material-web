...
import { cssClasses, strings, numbers, Corner, CornerBit } from "./constants.js";
/**
...
class MDCMenuFoundation extends MDCFoundation {
  ...
  close(evt = null) {
    const targetIsDisabled = evt ? this.adapter_.getAttributeForEventTarget(evt.target, strings.ARIA_DISABLED_ATTR) === 'true' : false;
