...
import { MDCTabBarScroller } from "../tabs/index.js";
import { style } from './mwc-tab-bar-scroller-css.js';
import { afterNextRender } from "../mwc-base/utils.js";
import "../mwc-icon/mwc-icon-font.js"; // this element depends on `mwc-tab-bar` to be registered ahead of time
...
class MDCWCTabBarScroller extends MDCWebComponentMixin(MDCTabBarScroller) {
  ...
  initialize() {
    super.initialize(e => this.tabBar); // TODO(sorvell): hack to get proper class on tabbar element.
...
export class TabBarScroller extends LitElement {
  ...
  async ready() {
    super.ready(); // TODO(sorvell): hack push scroller creation after tabbar... could expose promise.
