...
import { MDCTabBar } from "../tabs/index.js";
import { style } from './mwc-tab-bar-css.js';
import { afterNextRender } from "../mwc-base/utils.js"; // this element depends on `mwc-tab` to be registered ahead of time
...
class MDCWCTabBar extends MDCWebComponentMixin(MDCTabBar) {
  ...
  get tabs() {
    return Array.from(this.root_._host.querySelectorAll('mwc-tab')).filter(e => e._mdcComponent).map(e => e._mdcComponent);
  }
