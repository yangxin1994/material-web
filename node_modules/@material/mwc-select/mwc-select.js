...
import { MDCWebComponentMixin } from "../mwc-base/mdc-web-component.js";
import { MDCWCMenu } from "../mwc-menu/mwc-menu.js";
import { MDCSelect } from "../select/index.js";
import { style } from './mwc-select-css.js';
import { style as menuStyle } from "../mwc-menu/mwc-menu-css.js";
import { afterNextRender } from "../mwc-base/utils.js"; // this element depend on the `mwc-list-item` and `mwc-list-item-separator`
// elements to be registered ahead of time

import "../mwc-list/mwc-list-item.js";
import "../mwc-list/mwc-list-item-separator.js";
...
export class Select extends LitElement {
  ...
  nameditem(key) {
    this._mdcComponent.named; // NOTE: IE11 precludes us from using Array.prototype.find
